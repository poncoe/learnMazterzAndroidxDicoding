package id.poncoe.latihanmasterandroidponcoe.kotlin.backend.alarmmanager

import android.os.Bundle
import android.view.View
import androidx.appcompat.app.AppCompatActivity
import id.poncoe.latihanmasterandroidponcoe.kotlin.backend.alarmmanager.utils.DatePickerFragment
import id.poncoe.latihanmasterandroidponcoe.kotlin.backend.alarmmanager.utils.TimePickerFragment
import id.poncoe.latihanmasterandroidponcoe.R
import kotlinx.android.synthetic.main.activity_alarm_manager.*
import java.text.SimpleDateFormat
import java.util.*

class ActivityAlarmManager : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
