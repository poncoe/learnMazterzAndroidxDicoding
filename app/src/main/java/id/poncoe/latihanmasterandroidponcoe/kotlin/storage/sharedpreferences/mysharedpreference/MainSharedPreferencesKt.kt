package id.poncoe.latihanmasterandroidponcoe.kotlin.storage.sharedpreferences.mysharedpreference
...
class MainSharedPreferencesKt : AppCompatActivity(), View.OnClickListener {
    ...
    */
    ...
    override fun onClick(view: View) {
        if (view.id == R.id.btn_save) {
            val intent = Intent(this@MainSharedPreferencesKt, FormUserPreferenceActivity::class.java)
            when {
                isPreferenceEmpty -> {
