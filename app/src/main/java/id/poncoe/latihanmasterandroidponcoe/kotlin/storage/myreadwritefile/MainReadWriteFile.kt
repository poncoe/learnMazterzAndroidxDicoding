package id.poncoe.latihanmasterandroidponcoe.kotlin.storage.myreadwritefile
...
import kotlinx.android.synthetic.main.activity_readwritefile.*
import java.io.File
import java.util.*

class MainReadWriteFile : AppCompatActivity(), View.OnClickListener {
