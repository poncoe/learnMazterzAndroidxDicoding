package id.poncoe.latihanmasterandroidponcoe.java.storage.sharedpreferences.mysharedpreference;
...
public class MainSharedPreferences extends AppCompatActivity implements View.OnClickListener {
    ...
    */
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_save) {
            Intent intent = new Intent(MainSharedPreferences.this, FormUserPreferenceActivity.class);
