package id.poncoe.latihanmasterandroidponcoe.java.backend.loader;
...
public class ActivityLoader extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (PremissionManager.isGranted(this, Manifest.permission.READ_CONTACTS)) {
            getSupportLoaderManager().initLoader(CONTACT_LOAD, null, this);
        } else {
            PremissionManager.check(this, Manifest.permission.READ_CONTACTS, CONTACT_REQUEST_CODE);
        }
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (loader.getId() == CONTACT_LOAD) {
            ...
            if (PremissionManager.isGranted(this, Manifest.permission.CALL_PHONE)) {
                Intent dialIntent = new Intent(Intent.ACTION_CALL,
                        Uri.parse("tel:" + contactNumber));
                startActivity(dialIntent);
            } else {
                PremissionManager.check(this, Manifest.permission.CALL_PHONE, CALL_REQUEST_CODE);
            }
        }
    }
