...
import id.poncoe.latihanmasterandroidponcoe.java.storage.sqlite.adapter.NoteAdapter;
...
import id.poncoe.latihanmasterandroidponcoe.java.storage.sqlite.helper.MappingHelper;

public class MainMyNotes extends AppCompatActivity implements LoadNotesCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainMyNotes.this, NoteAddUpdateActivity.class);
