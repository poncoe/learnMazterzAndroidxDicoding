package id.poncoe.latihanmasterandroidponcoe.java.unittesting;
...
public class LatihanUnitTesting extends AppCompatActivity implements View.OnClickListener {
